...
import { deleteCategoryMaster, deleteClassMaster, deleteSession,deleteStudent } from '@/app/actions/fetch'

interface DeleteButtonProps {
  id: string | number
  model: 'sessionMaster' | 'student' | 'user' | 'classMaster' | 'CategoryMaster' // 👈 extend as needed
